...
return [
    ...
    */
    ...
    'custom' => [
        'nomhsw' => [
             'required' => 'Kolom No Mahasiswa harus diisi.',
             'string'   => 'Kolom No Mahasiswa harus berupa string.',
             'size'     => 'Kolom No Mahasiswa harus :size angka.',
             'unique'   => 'nomhsw sudah terpakai.',
         ],

        'nama_mahasiswa' => [
            'required' => 'Kolom Nama Mahasiswa harus diisi.',
            'string'   => 'Kolom Nama Mahasiswa harus berupa string.',
            'max'      => 'Kolom Nama Mahasiswa tidak boleh lebih dari :max karakter.',
        ],
        ...
        'id_semester'  => [
            'required' => 'Kolom Semester harus diisi.'
        ],
        ...
        'nama_semester' => [
            'required'  => 'Nama Semester harus diiisi.',
            'string'    => 'Nama Semester harus string.',
            'max'       => 'Nama Semester Maksimum 20 karakter.',
        ],

        'nama_jurusan' => [
            'required'  => 'Nama Jurusan harus diiisi.',
            'string'    => 'Nama Jurusan harus string.',
            'max'       => 'Nama Jurusan Maksimum 30 karakter.',
        ],
